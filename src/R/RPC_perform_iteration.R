...
RPC_perform_iteration <- function(df, expl_vars, time_col, censor_col, serial, beta, unique_event_times) {
    data <- preprocess.data(df, expl_vars, censor_col, time_col, serial)
